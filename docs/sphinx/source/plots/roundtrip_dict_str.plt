...
plot "dat/roundtrip_dict_str_str_2.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "Dict [str, str] <-> C++ <std::string, std::string> Length 2" with candlesticks whiskerbars 0.5, \
    "dat/roundtrip_dict_str_str_16.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
    ...
    "dat/roundtrip_dict_str_str_2.dat" using 1:(rate_100_000($1) * 1e6) t sprintf("Guide: %.3f µs + 0.1m objects/s", latency*1e6) with lines lw 2 dashtype 5, \
    "dat/roundtrip_dict_str_str_2.dat" using 1:(rate_1_000_000($1) * 1e6) t sprintf("Guide: %.3f µs + 1m objects/s", latency*1e6) with lines lw 2 dashtype 5, \
    "dat/roundtrip_dict_str_str_2.dat" using 1:(rate_10_000_000($1) * 1e6) t sprintf("Guide: %.3f µs + 10m objects/s", latency*1e6) with lines lw 2 dashtype 5, \
    "dat/roundtrip_dict_str_str_2.dat" using 1:(rate_100_000_000($1) * 1e6) t sprintf("Guide: %.3f µs + 100m objects/s", latency*1e6) with lines lw 2 dashtype 5, \
    "dat/roundtrip_dict_str_str_2.dat" using 1:(rate_1_000_000_000($1) * 1e6) t sprintf("Guide: %.3f µs + 1000m objects/s", latency*1e6) with lines lw 2 dashtype 5
...
plot "dat/roundtrip_dict_str_str_2.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "Dict [str, str] <-> C++ <std::string, std::string> Length 2" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_dict_str_str_2.dat" using 1:(1e6 * $3 / $1) t "Minimum Dict [str, str] <-> C++ <std::string, std::string> Length 2" with lines, \
    "dat/roundtrip_dict_str_str_16.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "Dict [str, str] <-> C++ <std::string, std::string> Length 16" with candlesticks whiskerbars 0.5,\
