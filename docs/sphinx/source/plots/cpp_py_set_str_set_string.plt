set title "Copy a Python set of str to a C++ set by string lengths."
set grid
...
plot "dat/test_unordered_set_string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6) * $4 / $9):(1e6 * $7 * $4 / $9):(1e6 * $8 * $4 / $9):(1e6 * ($5 + $6) * $4 / $9) \
        t "Set, bytes length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_unordered_set_string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6) * $4 / $9):(1e6 * $7 * $4 / $9):(1e6 * $8 * $4 / $9):(1e6 * ($5 + $6) * $4 / $9) \
        t "Set, bytes length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_unordered_set_string_to_py_set_multiple_std_string_1024.dat" using 3:(1e6 * ($5 - $6) * $4 / $9):(1e6 * $7 * $4 / $9):(1e6 * $8 * $4 / $9):(1e6 * ($5 + $6) * $4 / $9) \
...
plot "dat/test_unordered_set_string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6) * $4 / ($9 * $3)):(1e6 * $7 * $4 / ($9 * $3)):(1e6 * $8 * $4 / ($9 * $3)):(1e6 * ($5 + $6) * $4 / ($9 * $3)) \
    t "String length 16" with candlesticks whiskerbars 0.5 linetype 2,\
    "dat/test_unordered_set_string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * $7 / $3) t "" with lines linetype 2, \
    "dat/test_unordered_set_string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6) * $4 / ($9 * $3)):(1e6 * $7 * $4 / ($9 * $3)):(1e6 * $8 * $4 / ($9 * $3)):(1e6 * ($5 + $6) * $4 / ($9 * $3)) \
    t "String length 128" with candlesticks whiskerbars 0.5 linetype 4,\
    "dat/test_unordered_set_string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * $7 / $3) t "" with lines linetype 4, \
    "dat/test_unordered_set_string_to_py_set_multiple_std_string_1024.dat" using 3:(1e6 * ($5 - $6) * $4 / ($9 * $3)):(1e6 * $7 * $4 / ($9 * $3)):(1e6 * $8 * $4 / ($9 * $3)):(1e6 * ($5 + $6) * $4 / ($9 * $3)) \
    t "String length 1024" with candlesticks whiskerbars 0.5 linetype 7,\
