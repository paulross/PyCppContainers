set logscale x
set grid
set title "Time to convert a Python List [bytes] to a C++ std::list<std::vector<char>> then back to a Python List."
...
plot "dat/roundtrip_list_list_bytes_Byte_length_2.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "List [bytes] <-> C++ std::list<std::vector<char>> Length 2" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_list_bytes_Byte_length_16.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "List [bytes] <-> C++ std::list<std::vector<char>> Length 16" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_list_bytes_Byte_length_128.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "List [bytes] <-> C++ std::list<std::vector<char>> Length 128" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_list_bytes_Byte_length_1024.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
...
plot "dat/roundtrip_list_list_bytes_Byte_length_2.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "List [bytes] <-> C++ std::list<std::vector<char>> Length 2" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_list_bytes_Byte_length_2.dat" using 1:(1e6 * $3 / $1) t "Minimum List [bytes] <-> C++ std::list<std::vector<char>> Length 2" with lines, \
    "dat/roundtrip_list_list_bytes_Byte_length_16.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "List [bytes] <-> C++ std::list<std::vector<char>> Length 16" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_list_bytes_Byte_length_16.dat" using 1:(1e6 * $3 / $1) t "Minimum List [bytes] <-> C++ std::list<std::vector<char>> Length 16" with lines, \
    "dat/roundtrip_list_list_bytes_Byte_length_128.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "List [bytes] <-> C++ std::list<std::vector<char>> Length 128" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_list_bytes_Byte_length_128.dat" using 1:(1e6 * $3 / $1) t "Minimum List [bytes] <-> C++ std::list<std::vector<char>> Length 128" with lines, \
    "dat/roundtrip_list_list_bytes_Byte_length_1024.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "List [bytes] <-> C++ std::list<std::vector<char>> Length 1024" with candlesticks whiskerbars 0.5,\
