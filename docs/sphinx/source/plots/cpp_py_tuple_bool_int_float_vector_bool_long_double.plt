...
# Python to C++
set title "Time to copy a Python tuple of bool, int, float to a C++ std::vector<T>."
set key left
set ylabel "Time (µs)"
...
plot "dat/test_py_tuple_to_vector_multiple_bool.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python Tuple[bool] -> C++" with candlesticks whiskerbars 0.5,\
    "dat/test_py_tuple_to_vector_multiple_long.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python Tuple[int] -> C++" with candlesticks whiskerbars 0.5,\
    "dat/test_py_tuple_to_vector_multiple_double.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python Tuple[double] -> C++" with candlesticks whiskerbars 0.5,\
    "dat/test_py_tuple_to_vector_multiple_std_complex_double.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
set title "Time to copy a C++ std::vector<T> to a Python tuple of bool, int, float."
set ylabel "Time (µs)"

plot "dat/test_vector_to_py_tuple_multiple_bool.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "C++ Tuple<bool> -> Python" with candlesticks whiskerbars 0.5,\
    "dat/test_vector_to_py_tuple_multiple_long.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "C++ Tuple<long> -> Python" with candlesticks whiskerbars 0.5,\
    "dat/test_vector_to_py_tuple_multiple_std_complex_double.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
# Now the rate graphs.
# Python to C++
set title "Rate of copying a Python tuple of bool, int, float to a C++ std::vector<T>."
set key right
set ylabel "Time per Item (µs)"
...
plot "dat/test_py_tuple_to_vector_multiple_bool.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python Tuple[bool] -> C++" with candlesticks whiskerbars 0.5,\
        "dat/test_py_tuple_to_vector_multiple_bool.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_tuple_to_vector_multiple_long.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python Tuple[int] -> C++" with candlesticks whiskerbars 0.5,\
        "dat/test_py_tuple_to_vector_multiple_long.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_tuple_to_vector_multiple_double.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python Tuple[double] -> C++" with candlesticks whiskerbars 0.5,\
        "dat/test_py_tuple_to_vector_multiple_double.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_tuple_to_vector_multiple_std_complex_double.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python Tuple[complex] -> C++" with candlesticks whiskerbars 0.5,\
...
plot "dat/test_vector_to_py_tuple_multiple_bool.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    ...
    "dat/test_vector_to_py_tuple_multiple_long.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "C++ Tuple<long> -> Python" with candlesticks whiskerbars 0.5,\
        "dat/test_vector_to_py_tuple_multiple_long.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_vector_to_py_tuple_multiple_double.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "C++ Tuple<double> -> Python" with candlesticks whiskerbars 0.5,\
        "dat/test_vector_to_py_tuple_multiple_double.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_vector_to_py_tuple_multiple_std_complex_double.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "C++ Tuple<std::complex<double>> -> Python" with candlesticks whiskerbars 0.5,\
