set logscale x
set grid
set title "Python dict [str] to a C++ std::map<std::string> Roundtrip." noenhanced
...
plot "dat/roundtrip_dict_map_str_str_String_length_16.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "Dict [bytes, bytes] <-> C++ std::map<std::string, std::string> Length 16" with candlesticks whiskerbars 0.5, \
    "dat/roundtrip_dict_map_str_str_String_length_128.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "Dict [bytes, bytes] <-> C++ std::map<std::string, std::string> Length 128" with candlesticks whiskerbars 0.5, \
    "dat/roundtrip_dict_map_str_str_String_length_1024.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "Dict [bytes, bytes] <-> C++ std::map<std::string, std::string> Length 1024" with candlesticks whiskerbars 0.5, \
    "dat/roundtrip_dict_map_str_str_String_length_16.dat" using 1:(rate_100_000($1) * 1e6) t sprintf("Guide: %.3f µs + 0.1m objects/s", latency*1e6) with lines lw 2 dashtype 5, \
...
plot "dat/roundtrip_dict_map_str_str_String_length_16.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
    ...
    "dat/roundtrip_dict_map_str_str_String_length_16.dat" using 1:(1e6 * $3 / $1) t "Minimum, length 16" with lines, \
    "dat/roundtrip_dict_map_str_str_String_length_128.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "Length 128" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_dict_map_str_str_String_length_128.dat" using 1:(1e6 * $3 / $1) t "Minimum, length 128" with lines, \
    "dat/roundtrip_dict_map_str_str_String_length_1024.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "Length 1024" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_dict_map_str_str_String_length_1024.dat" using 1:(1e6 * $3 / $1) t "Minimum, length 1024" with lines
