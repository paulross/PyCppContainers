...
set output "images/roundtrip_list_ints_floats_and_bools_time.svg"   # choose the output device

plot "dat/roundtrip_list_bool.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
        t "List [bool] <-> C++ <bool>" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_int.dat" using 1:(1e6 * ($4 - $6)):(1e6 * $3):(1e6 * $7):(1e6 * ($4 + $6)) \
...
set output "images/roundtrip_list_ints_floats_and_bools_time.png"   # choose the output device
...
set terminal svg size 1400,700           # choose the file format
set output "images/roundtrip_list_ints_floats_and_bools_rate.svg"   # choose the output device

plot "dat/roundtrip_list_bool.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "List [bool] <-> C++ <bool>" with candlesticks whiskerbars 0.5,\
    "dat/roundtrip_list_bool.dat" using 1:(1e6 * $3 / $1) t "Minimum List [bool] <-> C++ <bool>" with lines, \
    "dat/roundtrip_list_int.dat" using 1:(1e6 * ($4 - $6) / $1):(1e6 * $3 / $1):(1e6 * $7 / $1):(1e6 * ($4 + $6) / $1) \
        t "List [int] <-> C++ <long>" with candlesticks whiskerbars 0.5,\
