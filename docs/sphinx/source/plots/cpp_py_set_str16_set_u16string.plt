...
set output "images/cpp_py_set_str16_unordered_set_u16string_time.svg"   # choose the output device
...
set output "images/cpp_py_set_str16_unordered_set_u16string_time.png"   # choose the output device
...
set terminal svg size 700,400           # choose the file format
set output "images/cpp_py_set_str16_unordered_set_u16string_rate.svg"   # choose the output device
...
set terminal png size 700,400           # choose the file format
set output "images/cpp_py_set_str16_unordered_set_u16string_rate.png"   # choose the output device
...
set terminal svg size 700,400           # choose the file format
set output "images/cpp_unordered_set_u16string_to_py_set_multiple_std_string_time.svg"   # choose the output device

plot "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6) * $4 / $9):(1e6 * $7 * $4 / $9):(1e6 * $8 * $4 / $9):(1e6 * ($5 + $6) * $4 / $9) \
        t "Set, bytes length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6) * $4 / $9):(1e6 * $7 * $4 / $9):(1e6 * $8 * $4 / $9):(1e6 * ($5 + $6) * $4 / $9) \
...
set terminal png size 700,400           # choose the file format
set output "images/cpp_unordered_set_u16string_to_py_set_multiple_std_string_time.png"   # choose the output device
...
set terminal svg size 700,400           # choose the file format
set output "images/cpp_unordered_set_u16string_to_py_set_multiple_std_string_rate.svg"   # choose the output device

plot "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6) * $4 / ($9 * $3)):(1e6 * $7 * $4 / ($9 * $3)):(1e6 * $8 * $4 / ($9 * $3)):(1e6 * ($5 + $6) * $4 / ($9 * $3)) \
    t "String length 16" with candlesticks whiskerbars 0.5 linetype 2,\
    "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * $7 / $3) t "" with lines linetype 2, \
    "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6) * $4 / ($9 * $3)):(1e6 * $7 * $4 / ($9 * $3)):(1e6 * $8 * $4 / ($9 * $3)):(1e6 * ($5 + $6) * $4 / ($9 * $3)) \
    t "String length 128" with candlesticks whiskerbars 0.5 linetype 4,\
    "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * $7 / $3) t "" with lines linetype 4, \
    "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_1024.dat" using 3:(1e6 * ($5 - $6) * $4 / ($9 * $3)):(1e6 * $7 * $4 / ($9 * $3)):(1e6 * $8 * $4 / ($9 * $3)):(1e6 * ($5 + $6) * $4 / ($9 * $3)) \
    t "String length 1024" with candlesticks whiskerbars 0.5 linetype 7,\
    "dat/test_unordered_set_u16string_to_py_set_multiple_std_string_1024.dat" using 3:(1e6 * $7 / $3) t "" with lines linetype 7

set terminal png size 700,400           # choose the file format
set output "images/cpp_unordered_set_u16string_to_py_set_multiple_std_string_rate.png"   # choose the output device
