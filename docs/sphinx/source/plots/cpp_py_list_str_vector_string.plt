...
set title "Time to copy a Python list of str to a C++ std::vector<std::string> by string lengths."
set ylabel "Time (µs)"
...
plot "dat/test_py_list_str_to_vector_string_multiple_std_string_2.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python List -> C++, string length 2" with candlesticks whiskerbars 0.5,\
    "dat/test_py_list_str_to_vector_string_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python List -> C++, string length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_py_list_str_to_vector_string_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python List -> C++, string length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_py_list_str_to_vector_string_multiple_std_string_1024.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
set title "Time to copy a C++ std::vector<std::string> to a Python list of str by string lengths."
set ylabel "Time (µs)"
...
# Now the rate graph.
set title "Rate of Copying a Python list of str to a C++ std::vector<std::string> by string lengths."
set ylabel "Time per Item (µs)"
set yrange[0.001:1]
...
plot "dat/test_py_list_str_to_vector_string_multiple_std_string_2.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 2" with candlesticks whiskerbars 0.5,\
    "dat/test_py_list_str_to_vector_string_multiple_std_string_2.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_list_str_to_vector_string_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_py_list_str_to_vector_string_multiple_std_string_16.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_list_str_to_vector_string_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_py_list_str_to_vector_string_multiple_std_string_128.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_list_str_to_vector_string_multiple_std_string_1024.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 1024" with candlesticks whiskerbars 0.5,\
...
set title "Rate of Copying a C++ std::vector<std::string> to a Python list of str by string lengths."
set ylabel "Time per Item (µs)"
#set yrange[0.01:1]
