...
plot "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_2.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python List -> C++, string length 2" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_16.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python List -> C++, string length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_128.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python List -> C++, string length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_1024.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
plot "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_2.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
    ...
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_16.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "C++ List -> Python, string length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_128.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "C++ List -> Python, string length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_1024.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
plot "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_2.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 2" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_2.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_16.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_16.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_128.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_128.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_list_like_u32string_to_py_list_multiple-std_list_std_u32string_1024.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python List -> C++, string length 1024" with candlesticks whiskerbars 0.5,\
...
plot "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_2.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
            t "C+ List -> Python, string length 2" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_2.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_16.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "C+ List -> Python, string length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_16.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_128.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "C+ List -> Python, string length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_128.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_list_like_u32string_to_py_list_multiple-std_vector_std_u32string_1024.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "C+ List -> Python, string length 1024" with candlesticks whiskerbars 0.5,\
