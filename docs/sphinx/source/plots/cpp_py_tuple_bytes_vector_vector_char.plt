...
plot "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_2.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
    ...
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_16.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python Tuple -> C++, vector<char> length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_128.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Python Tuple -> C++, vector<char> length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_1024.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
plot "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_2.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
    ...
    "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_16.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "C++ List -> Python tuple, bytes length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_128.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "C++ List -> Python tuple, bytes length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_1024.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
plot "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_2.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    ...
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_16.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python Tuple -> C++, vector<char> length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_16.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_128.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python Tuple -> C++, vector<char> length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_128.dat" using 3:(1e6 * $7 / $3) t "" with lines, \
    "dat/test_py_tuple_bytes_to_vector_vector_char_multiple_std_vector_char_1024.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
        t "Python Tuple -> C++, vector<char> length 1024" with candlesticks whiskerbars 0.5,\
...
plot "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_2.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    ...
    "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_16.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    ...
    "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_128.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    ...
    "dat/test_vector_vector_char_to_py_tuple_multiple_std_vector_char_1024.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
