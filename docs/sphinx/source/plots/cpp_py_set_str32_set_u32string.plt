...
plot "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Set, bytes length 16" with candlesticks whiskerbars 0.5,\
    "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
        t "Set, bytes length 128" with candlesticks whiskerbars 0.5,\
    "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_1024.dat" using 3:(1e6 * ($5 - $6)):(1e6 * $7):(1e6 * $8):(1e6 * ($5 + $6)) \
...
plot "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    t "String length 16" with candlesticks whiskerbars 0.5 linetype 2,\
    "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_16.dat" using 3:(1e6 * $7 / $3) t "" with lines linetype 2, \
    "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    t "String length 128" with candlesticks whiskerbars 0.5 linetype 4,\
    "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_128.dat" using 3:(1e6 * $7 / $3) t "" with lines linetype 4, \
    "dat/test_unordered_set_u32string_to_py_set_multiple_std_string_1024.dat" using 3:(1e6 * ($5 - $6) / $3):(1e6 * $7 / $3):(1e6 * $8 / $3):(1e6 * ($5 + $6) / $3) \
    t "String length 1024" with candlesticks whiskerbars 0.5 linetype 7,\
