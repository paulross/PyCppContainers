...
#plot "test_new_list_float.dat" using 1:(1e6 * $2 / $1):(1e6 * $4 / $1):(1e6 * $5 / $1) t "String length 128" with yerrorbars

plot "test_new_list_float.dat" using 1:(1e6 * $3 / $1) t "Floats" with linespoints, \
