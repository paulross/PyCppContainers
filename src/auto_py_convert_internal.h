...
template<typename T>
PyObject *
std_vector_to_py_tuple(const std::vector<T> &container);
// Instantiations
template <>
PyObject *
...
template<typename T>
int
py_tuple_to_std_vector(PyObject *tuple, std::vector<T> &container);
// Instantiations
template <>
int
py_tuple_to_std_vector<double>(PyObject *tuple, std::vector<double> &container);
