...
Custom_init(CustomObject *self, PyObject *args, PyObject *kwds) {
    static char *kwlist[] = {const_cast<char *>("first"), const_cast<char *>("last"), const_cast<char *>("number"), NULL};
...
cpp_std_list_like_to_py_list<CppCustomObject>(const std::vector<CppCustomObject> &container) {
    return Python_Cpp_Containers::generic_cpp_std_list_like_to_py_list<
...
py_list_to_cpp_std_list_like<CppCustomObject>(PyObject *op, std::vector<CppCustomObject> &container) {
    return Python_Cpp_Containers::generic_py_list_to_cpp_std_list_like<
...
reverse_names(PyObject *Py_UNUSED(module), PyObject *arg) {
    ...
    if (! py_list_to_cpp_std_list_like(arg, input)) {
        ...
        return cpp_std_list_like_to_py_list(output);
    }
    return NULL;
}
...
static PyMethodDef cUserDefinedMethods[] = {
        {"reverse_names", reverse_names, METH_O,
                "Take a list of cUserDefined.Custom objects and return a new list with the name reversed."},
