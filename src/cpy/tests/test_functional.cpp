...
void test_functional_tuple_setitem(TestResultS &test_results) {
    ...
    if (container) {
        ...
        PyObject *py_str = Python_Cpp_Containers::cpp_string_to_py_unicode8(cpp_str);
...
void test_functional_dict_setitem(TestResultS &test_results) {
    ...
    if (container) {
        ...
        PyObject *py_str_key = Python_Cpp_Containers::cpp_string_to_py_unicode8(cpp_str_key);
        // Check reference count of py_str_key.
        result |= Py_REFCNT(py_str_key) != 1;
        PyObject *py_str_val = Python_Cpp_Containers::cpp_string_to_py_unicode8(cpp_str_val);
        // Check reference count of py_str_key.
...
void test_functional_tuple(TestResultS &test_results) {
    ...
    // Test for string8/str8
    test_py_tuple_str_to_vector(test_results, 1024, 32);
    // Test for string16
    test_vector_u16string_to_py_tuple(test_results, 1024, 32);
    test_py_tuple_str16_to_vector(test_results, 1024, 32);
    // Test for string32
    test_vector_u32string_to_py_tuple(test_results, 1024, 32);
    test_py_tuple_str32_to_vector(test_results, 1024, 32);
}
